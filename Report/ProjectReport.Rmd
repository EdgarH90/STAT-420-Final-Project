...
- Now we can use our test data to compare the average percent error between the models:
```{r indent = "  "}
...
- Calculating the test RMSE for our models:
```{r}
...
- Plotting our predicted salaries vs the actual test set salaries:
```{r indent = "  "}
